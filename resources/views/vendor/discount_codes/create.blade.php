...
<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        <h5 class="fw-bold mb-4">إضافة كوبون جديد</h5>

        <form action="{{ route('vendor.discount_code.store') }}" method="POST">
            @csrf

            <div class="row g-4">
                <div class="col-md-6">
                    <label class="form-label fw-semibold">اسم الكوبون</label>
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="مثال: خصم الصيف">
                    @error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="col-md-6">
                    <label class="form-label fw-semibold">كود الخصم</label>
                    <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" placeholder="مثال: SUMMER24">
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex gap-4 mt-2">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="discount_type" id="type_percentage" value="percentage" {{ old('discount_type', 'percentage') == 'percentage' ? 'checked' : '' }}>
                            <label class="form-check-label" for="type_percentage">نسبة مئوية (%)</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="discount_type" id="type_price" value="price" {{ old('discount_type') == 'price' ? 'checked' : '' }}>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="number_of_used" class="form-control @error('number_of_used') is-invalid @enderror" value="{{ old('number_of_used', 100) }}">
                ...
                <div class="col-12">
                    ...
                    <select name="product_ids[]" class="form-select product-select @error('product_ids') is-invalid @enderror" multiple>
                        <option value="" disabled>اختر المنتجات (أو اتركه فارغاً لجميع منتجاتك)</option>
                    </select>
            ...
            <div class="mt-5 border-top pt-4">
                <button type="submit" class="btn btn-primary px-5">حفظ الكوبون</button>
