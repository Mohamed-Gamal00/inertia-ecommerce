<template>
    <div style="background:#f5f6fa; min-height:100vh; padding-bottom:48px">
        <div style="background:linear-gradient(135deg,#1a237e,#3949ab); padding:40px 16px 50px">
            <h1 class="text-white font-weight-bold text-center" style="font-size:28px">طلبات المناديب</h1>
            <p class="text-center mt-2" style="color:rgba(255,255,255,0.75); font-size:14px">انضم إلى شبكة مناديبنا</p>
        </div>
        ...
        <div style="max-width:600px; margin:32px auto; padding:0 16px">
            <v-card rounded="xl" elevation="1" class="pa-6">
                ...
                <p class="text-grey-darken-1 mb-5" style="font-size:14px; line-height:1.8">
                    هل تريد أن تكون مندوباً لمتجرنا؟ أرسل بياناتك وسنتواصل معك.
                </p>
