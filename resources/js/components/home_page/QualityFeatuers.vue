<template>
  <div class="quality-featuers py-13 bg-grey-lighten-2">
    <v-container fluid>
      <v-row>
        <v-col v-for="card in cards" :key="card.title" class="px-2">
          <v-hover v-slot="{ isHovering, props }">
            <v-card
              ...
              style="cursor: pointer; transition: all 0.33s ease-in-out"
            >
              <div class="parent">
      ...
      cards: [
        {
          ...
          desc: "Comperhensive quality control and afforable prices",
        ...
        },
        {
          ...
          desc: "2417 Customer serv.ce - We'reand happy to help",
